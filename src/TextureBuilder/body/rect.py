...
class Rect:
    ...
    def build(self):
        print(f'{Builder}: {self.__name}(type: rect, width: {self.__width}, height: {self.__height}, fill-color: {self.__fill_color}, outline: {self.__outline_size}, outline-color: {self.__outline_color})正在构建...')
